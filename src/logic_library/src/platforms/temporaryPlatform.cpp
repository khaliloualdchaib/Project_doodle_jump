...
bool DoodleJump::TemporaryPlatform::temporaryJumped() const { return temporaryjumped; }
...
void DoodleJump::TemporaryPlatform::settemporaryJumped(bool b) { temporaryjumped = b; }