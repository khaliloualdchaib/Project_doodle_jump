...
void DoodleJump::Score::addScoreHeight() { score++; }

void DoodleJump::Score::addScoreSpring() { score = score + 6; }

void DoodleJump::Score::addScoreJetpack() { score = score + 7; }
...
int DoodleJump::Score::getScore() const { return score; }
